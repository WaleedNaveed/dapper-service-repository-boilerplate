...
```bash
{
  ...
  "ConnectionStrings": {
    "DefaultConnection": "", // ADD YOUR DATABASE CONNECTION STRING
    "Redis": "" // ADD YOUR REDIS CONNECTION STRING (SERVER)
  },
  ...
  // SUPER ADMIN CREDENTIALS (DEFAULT USER, WILL BE CREATED WHEN YOU RUN THE PROJECT)
  ...
  // UPDATE IF YOU WANT TO CHANGE RATE LIMIT FOR APIs
  "RateLimiting": {
    "PerUser": {
  ...
  "SetPasswordLinkExpiryMinutes": 60, // PASSWORD SET / FORGOT PASSWORD EMAIL LINK EXPIRY TIME
  "AppUrl": "https://yourFrontEndAppUrl.com/" // YOUR FRONT-END APPLICATION URL
}
```
