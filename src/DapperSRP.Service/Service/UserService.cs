...
namespace DapperSRP.Service.Service
{
    public class UserService : IUserService
    {
        ...
        public async Task<ServiceResponse<LoginResponse>> LoginAsync(LoginRequest request)
        {
            ...
            u.RefreshTokenExpiry = DateTime.UtcNow.AddDays(_jwt.Value.RefreshTokenExpiryDays);
        ...
        public async Task<ServiceResponse<LoginResponse>> RefreshTokenAsync(RefreshTokenRequest request)
        {
            ...
            user.RefreshTokenExpiry = DateTime.UtcNow.AddDays(_jwt.Value.RefreshTokenExpiryDays);
